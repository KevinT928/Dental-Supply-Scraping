...
Notes about the project:
    ...
    playwright can see the "next page" button, and the HTML is being loading (confirmed by count = 1)
    ...
    Currently, main.py only accepts 3 items per category, because of limited available tokens
